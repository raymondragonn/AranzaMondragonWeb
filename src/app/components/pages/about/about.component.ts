...
export class AboutComponent implements OnInit {
    ...
    originalParagraphs = [
        ...
        "Hasta que a mis 16 años, durante la pandemia, comencé a hacer ejercicio y me encantó. Me enfoqué tanto en \"verme tonificada\" que caí en el extremo:",
        "• Ejercitarme diario y sentir culpa si faltaba",
        "• No comer comida de mi abuela",
        "• Comer ensaladas en vez de lo que había de comer porque tenían menos calorías y era más \"saludable\".",
        "• Incluso dejando de probar pastel en mi cumpleaños.",
        ...
        "Y así creé <strong>The Confidence Method</strong>, un programa online dedicado a ayudar personalmente a mujeres a lograrlo <strong>sin pasar horas interminables en el gym, comiendo rico y flexible</strong>."
    ];
    ...
    aboutContent = [
        {
            ...
            paragraphList: [
                {
                    paragraph: "Soy <strong>coach nutricional y de entrenamiento</strong> especializada en mujeres y <strong>psicóloga</strong>. Pero más allá de eso, soy una mujer que también ha pasado por inseguridades corporales y errores en el fitness.",
                },
                {
